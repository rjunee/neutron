...
## 2026-08-11 — the ⚛ app icon reads as an atom, and the pipeline now checks pixels
...
Two further defects, both found by rendering the committed files and looking at them: at
aspect 1.85 the mark read as a **six-lobed rosette** rather than an atom (fixed by
flattening the orbits to aspect 2.11), and the union of the three bands left **six
opaque background nicks** near the orbit crossings, visible on a 1024px launcher tile —
geometry, not a compositing artefact, and closed by the heavier stroke.

**`landing/apple-touch-icon.png` was still the artwork Ryan rejected on 2026-07-30** —
