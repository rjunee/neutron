...
> **Authority:** implements SPEC.md Decisions Log 2026-06-22 ("TABBED project interface + Cores install-scope…") + WAVE 3 Phases→Steps (SPEC.md:184-186). v1 scope confirmed by the owner 2026-06-22.
