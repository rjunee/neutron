...
**Parity source:** `docs/research/legacy-neutron-feature-parity-scan-2026-06-25.md` §5 gap #2 (line 97, 180) + the gap-#6 forge's repo-wide chat-command-filter finding.
