# Plan — Port the legacy harness #11: Per-turn API-5xx dead-turn notifier (JSONL watcher)
...
- **GAP:** the 5xx-abort-before-reply case is undetected — the user sees nothing (the owner 2026-06-16).
