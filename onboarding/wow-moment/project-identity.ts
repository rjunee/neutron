 ...
 * freeform-added project ("Buddhism", "Wellness-lab") that has no
 ...
 * "Wellness-lab" matches an inferred interest "wellness-lab / cold plunge"
 * AND a topic "wellness-lab" matches the project "Wellness-lab & Sleep").
 *
 ...
 *      makes a freeform-added project ("Buddhism", "Wellness-lab") that
