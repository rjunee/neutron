...
Buddhism and Wellness-lab" means `primary_projects` = ["Topline", "Northwind",
"Acme", "Buddhism", "Wellness-lab"] — all five, even if Buddhism and
Wellness-lab were never in the list you showed. NEVER silently drop a project
...
remove ("drop the personal one", "skip Wellness-lab", "lose the AC project").
