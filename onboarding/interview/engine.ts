 ...
 * still catch it). This recovers a tidy comma list ("Tabs, Willow, Verdance,
 * Neutron, Wordsmith, meditation") AND the proper-noun-rich shape Ryan actually
 * typed ("Running three companies: Tabs, Willow and Verdance. Side project
 * Neutron (open source agent harness), side project Wordsmith, and
