 ...
 *
 * The Neutron-Open port of the legacy harness's `overnight-dispatcher.ts`, with the
...
/** Documented caps (the legacy harness code drifted to 4/40; the spec pins 2/8). */
