...
export class WorkBoardClient extends GatewayHttpClient {
...
function parseRunProgress(raw: unknown): RunProgress | null {
  ...
  // Only an explicitly present legacy boolean maps to a strategy. Absence stays
  // unknown so a rolling-deploy frame never invents `single`.
