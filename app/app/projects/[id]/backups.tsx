...
const makeStyles = (theme: NeutronTheme) =>
  StyleSheet.create({
    ...
    fileBadgeAdded: { backgroundColor: theme.success_surface },
    fileBadgeTextAdded: { color: theme.success },
    fileBadgeDeleted: { backgroundColor: theme.danger_surface },
    fileBadgeTextDeleted: { color: theme.danger },
    fileBadgeModified: { backgroundColor: theme.info_surface },
    fileBadgeTextModified: { color: theme.info },
