// Rationale: inner-workflow-rationale.md#rationale-001 (formerly line 1).
...
// Rationale: inner-workflow-rationale.md#rationale-002 (formerly line 333).
...
// Rationale: inner-workflow-rationale.md#rationale-003 (formerly line 372).
...
// Rationale: inner-workflow-rationale.md#rationale-004 (formerly line 954).
...
const CODEX_FORGE_SCHEMA = {
  ...
  properties: {
    // Rationale: inner-workflow-rationale.md#rationale-005 (formerly line 1078).
...
// Rationale: inner-workflow-rationale.md#rationale-006 (formerly line 1187).
...
// Rationale: inner-workflow-rationale.md#rationale-007 (formerly line 1380).
...
// Rationale: inner-workflow-rationale.md#rationale-008 (formerly line 1405).
...
function unpinnedDiffBase() {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-009 (formerly line 1560).
  ...
  // Rationale: inner-workflow-rationale.md#rationale-010 (formerly line 1590).
...
// Rationale: inner-workflow-rationale.md#rationale-011 (formerly line 1748).
...
// Rationale: inner-workflow-rationale.md#rationale-012 (formerly line 1820).
...
// Rationale: inner-workflow-rationale.md#rationale-013 (formerly line 1860).
const CODEX_BRIEF_CHUNK_BYTES = 3072

// Rationale: inner-workflow-rationale.md#rationale-014 (formerly line 1920).
...
// Rationale: inner-workflow-rationale.md#rationale-015 (formerly line 1994).
...
// Rationale: inner-workflow-rationale.md#rationale-016 (formerly line 2570).
...
// Rationale: inner-workflow-rationale.md#rationale-017 (formerly line 2788).
...
// Rationale: inner-workflow-rationale.md#rationale-018 (formerly line 2867).
async function writeTerminalResult(result) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-019 (formerly line 2925).
...
// Rationale: inner-workflow-rationale.md#rationale-021 (formerly line 3042).
...
// Rationale: inner-workflow-rationale.md#rationale-022 (formerly line 3175).
...
// Rationale: inner-workflow-rationale.md#rationale-023 (formerly line 3226).
...
// Rationale: inner-workflow-rationale.md#rationale-024 (formerly line 3337).
...
// Rationale: inner-workflow-rationale.md#rationale-025 (formerly line 3411).
function classifyBlock(synthesis, deferredPeers, noReviewRan = false, panelRejectedWithoutReason = false) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-026 (formerly line 3448).
  if (findings.length === 0) return 'code'
  // Rationale: inner-workflow-rationale.md#rationale-027 (formerly line 3474).
  if (panelRejectedWithoutReason) return 'infra-only'
  return noReviewRan ? 'infra-only' : 'advisory-only'
}

// Rationale: inner-workflow-rationale.md#rationale-028 (formerly line 3498).
...
// Rationale: inner-workflow-rationale.md#rationale-030 (formerly line 3750).
...
// Rationale: inner-workflow-rationale.md#rationale-031 (formerly line 3909).
...
// Rationale: inner-workflow-rationale.md#rationale-032 (formerly line 4132).
...
// Rationale: inner-workflow-rationale.md#rationale-033 (formerly line 4277).
...
// Rationale: inner-workflow-rationale.md#rationale-034 (formerly line 4456).
...
// Rationale: inner-workflow-rationale.md#rationale-035 (formerly line 4547).
const REVIEW_READINESS_BUDGET_MS = 900000
const REVIEW_READINESS_RETRY_MS = 30000
// Rationale: inner-workflow-rationale.md#rationale-036 (formerly line 4581).
...
// Rationale: inner-workflow-rationale.md#rationale-037 (formerly line 4669).
...
// Rationale: inner-workflow-rationale.md#rationale-038 (formerly line 4730).
const TERMINAL_CAUSE_DIAGNOSTIC_MAX = 120
// Rationale: inner-workflow-rationale.md#rationale-039 (formerly line 4779).
...
// Rationale: inner-workflow-rationale.md#rationale-040 (formerly line 4915).
...
function classifyRequiredChecksProbe(probe) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-041 (formerly line 5037).
  ...
  // Rationale: inner-workflow-rationale.md#rationale-042 (formerly line 5113).
  ...
  const listFrom = (text, key) => {
    ...
    // Rationale: inner-workflow-rationale.md#rationale-044 (formerly line 5266).
...
// Rationale: inner-workflow-rationale.md#rationale-045 (formerly line 5302).
...
function classifyReviewReadiness(probe, requiredConfig, elapsedMs = 0) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-046 (formerly line 5447).
  ...
  if (required.length > 0) {
    for (const name of required) {
      ...
      // Rationale: inner-workflow-rationale.md#rationale-047 (formerly line 5511).
      if (
        produced !== null &&
        produced.length > 0 &&
 ...
 * `unknown`, which joins the existing deferred-peer refusal below. */
...
function codeScanningDeferredPeer(scan) {
  const said = typeof scan.cause === 'string' && scan.cause !== '' ? ` The probe said: "${scan.cause}".` : ''
  return {
    name: 'Code scanning alerts',
    title: 'CODE SCANNING ALERTS UNREADABLE — refusing to silently APPROVE',
    evidence: `GitHub's code-scanning alerts could not be fetched.${said} "Could not fetch" is not "zero alerts"; restore the read and re-run.`,
  }
}
...
// Rationale: inner-workflow-rationale.md#rationale-048 (formerly line 5873).
...
// Rationale: inner-workflow-rationale.md#rationale-049 (formerly line 5927).
...
// Rationale: inner-workflow-rationale.md#rationale-050 (formerly line 6234).
...
// Rationale: inner-workflow-rationale.md#rationale-051 (formerly line 6341).
...
function withSuiteBlocker(synthesis, suiteFindings) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-052 (formerly line 6547).
...
// Rationale: inner-workflow-rationale.md#rationale-053 (formerly line 6625).
...
// Rationale: inner-workflow-rationale.md#rationale-054 (formerly line 6661).
...
// Rationale: inner-workflow-rationale.md#rationale-055 (formerly line 6703).
function seatRateLimitKey(group) {
  if (group === 'claude') return null
  return group === 'kimi' ? 'kimiRateLimited' : 'codexRateLimited'
}

// Rationale: inner-workflow-rationale.md#rationale-056 (formerly line 6733).
...
// Rationale: inner-workflow-rationale.md#rationale-057 (formerly line 6828).
...
// Rationale: inner-workflow-rationale.md#rationale-059 (formerly line 7007).
...
async function reviewAndSynthesize(diffFile, round, prForCi, suiteFindings = []) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-060 (formerly line 7140).
...
TASK: ${task}`
  ...
  const codeScanningPrompt = codeScanning.status === 'unknown'
    ? '\nCODE-SCANNING ALERT FETCH FAILED: the workflow could not read GitHub code-scanning alerts. This is not evidence that there are zero alerts, and the deterministic gate refuses approval.'
...
${kimiPanelLine}${suiteFindingsPrompt}${ciFindingsPrompt}${codeScanningPrompt}`,
  ...
  const withCi =
    ci.status === 'red'
      ? ciFindingsBlock(ciFindings)
        ...
        // Rationale: inner-workflow-rationale.md#rationale-061 (formerly line 7524).
        : severityGated
          ? {
              ...severityGated,
              verdict: 'REQUEST_CHANGES',
  ...
  if (codeScanning.status === 'unknown') peers.push(codeScanningDeferredPeer(codeScanning))
...
try {
  ...
  if (resumeMode === 'approved') {
    ...
    finalVerdict = 'APPROVE'
    // Rationale: inner-workflow-rationale.md#rationale-062 (formerly line 7740).
    const resumeResult = {
      ok: true,
      prNumber: pr,
      branch: forgeBranch,
  ...
  // Rationale: inner-workflow-rationale.md#rationale-063 (formerly line 7834).
  ...
  // Rationale: inner-workflow-rationale.md#rationale-064 (formerly line 7877).
...
${task}${reflectionGuidance}`,
    ...
    // Rationale: inner-workflow-rationale.md#rationale-066 (formerly line 8316).
    ...
    // Rationale: inner-workflow-rationale.md#rationale-067 (formerly line 8367).
    if (memberMode) {
  ...
  // Rationale: inner-workflow-rationale.md#rationale-068 (formerly line 8544).
  ...
  const recordRoundForEscalation = (roundNumber, s) => {
    ...
    // Rationale: inner-workflow-rationale.md#rationale-069 (formerly line 8636).
    const judgedCode =
      s.blockKind === 'code' &&
  ...
  // Rationale: inner-workflow-rationale.md#rationale-070 (formerly line 8728).
  while (
    escalation === null &&
    round < maxRounds &&
    (rePlanPending ||
    ...
    round++
    // Rationale: inner-workflow-rationale.md#rationale-071 (formerly line 8768).
    if (rePlanPending) {
      rePlanPending = false
...
${task}${rePlanNote}${reflectionGuidance}`,
    ...
    diffFile = fixDiff
    // Rationale: inner-workflow-rationale.md#rationale-073 (formerly line 9005).
  ...
  // Rationale: inner-workflow-rationale.md#rationale-075 (formerly line 9281).
