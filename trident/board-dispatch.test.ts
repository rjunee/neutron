...
describe('branch liveness refusal (branch_live)', () => {
  ...
  test('a cross-connection SQLITE_BUSY on the insert refuses branch_live and QUEUES the card', async () => {
    ...
    const racingStore = {
      ...
      // dispatch that survives the liveness refusal, and a stub that omits it
      // throws a TypeError before the race this test is about can happen.
      latestTerminalBySlug: (project: string, s: string) => store.latestTerminalBySlug(project, s),
