...
export function makeTridentRun(over: Partial<TridentRun> = {}): TridentRun {
  return {
    ...
    strategy_rationale: 'Test fixture selects a single builder invocation.',
    strategy_plan: '# Implementation plan\n\nBuild the requested test fixture change.',
    strategy_source: 'planner',
    task_iteration: 0,
    task_total: null,
