...
### 2026-09-12 — RECURRING CROSS-MODEL WORK IS ONE-SHOT HEADLESS PER CALL, ON A REUSED THREAD ID. Settles the spike the 2026-09-11 pivot entry left open (§3.3, criterion verbatim there). Spec item: [`docs/spec-items/codex-work-runs-headless-per-call-on-a-reused-thread.md`](docs/spec-items/codex-work-runs-headless-per-call-on-a-reused-thread.md). Measurements: `docs/as-built/` for this change.
