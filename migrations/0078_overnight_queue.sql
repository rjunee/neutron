...
--
-- This is the Neutron-Open (SQLite-native) translation of the legacy harness's
-- `gateway/overnight-queue.json` + per-window budget counters. Where the legacy harness
...
-- Column rationale:
--
-- * `id` — the owk-id (`owk-YYYYMMDD-NNN`, the legacy harness format), human-facing PK
