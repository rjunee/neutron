 ...
 * the legacy harness's named-specialist + ad-hoc spawn model (`spawn-agent.sh` →
 * `~/legacy/docs/reference/agents.md`):
 *
 ...
 *     pre-baked persona. Mirrors the legacy harness's bare `spawn-agent.sh "<task>"`.
 *
