 ...
 *   Ported from the legacy harness `stuck-turn-watchdog.ts` (incident 2026-04-21): a topic CC
...
export interface AgentWatchdogDeps {
   ...
   * `last_event_at` can't keep a wedged turn looking alive (the legacy harness
