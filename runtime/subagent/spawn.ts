 ...
 *
 * Lifted from Legacy-agent's `subagent-spawn.ts` shape, hardened with the
 ...
 *
 * The double-spawn guard (step 0) mirrors the the legacy harness incident class where a
