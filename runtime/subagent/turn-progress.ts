 ...
 *
 * Ported from the legacy harness `stuck-turn-watchdog.ts` (incident 2026-04-21). The lesson:
 ...
 * regardless of how large the JSONL has grown. Matches the the legacy harness tail window.
 */
 ...
 * which is the key difference from the legacy harness's *operator-input* filter, where
