 ...
 *
 * § Terminal-detection port, master-table row #1 (docs/research/legacy-terminal-
 * detection-keystroke-port-2026-06-25.md), the dispatch-locked flagship. Ports
 * the legacy harness's `pane-scan-watchdog.ts isWedgedInteractivePrompt` / `runWedgedRecovery`
 ...
 *   • Bottom-N widened 8→24 after the 2026-06-16 Wordsmith miss (a status panel
 ...
 *  8→24 after the 2026-06-16 Wordsmith status-panel-below-footer miss). */
