...
// D1: `pool-state.ts` types its collections against the session class — export
// the TYPE only (the class value stays module-private; the type import is
// erased at compile time, so no runtime cycle exists).
