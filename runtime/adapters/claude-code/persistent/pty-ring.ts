 ...
 *
 * § Terminal-detection port, prereq F1 (docs/research/legacy-terminal-detection-
 * keystroke-port-2026-06-25.md). the legacy harness's tmux era treated the pane as the I/O
 ...
 *
 *   • a widened buffer (64 KB vs the old 16 KB) — the 2026-06-16 Wordsmith miss
 ...
 *  guards can see content rendered below the footer (Wordsmith 2026-06-16). */
