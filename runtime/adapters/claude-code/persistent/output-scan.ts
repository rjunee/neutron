 ...
 *
 * § Terminal-detection port, prereq F3 (docs/research/legacy-terminal-detection-
 * keystroke-port-2026-06-25.md). This is Neutron's analog of the legacy harness's
 ...
 *
 * The the legacy harness invariants are BAKED IN — each encodes a paid-for production
 ...
 *      Wordsmith status-panel-below-footer miss).
...
/** Default bottom-N window. Widened 8→24 after the 2026-06-16 Wordsmith miss
