 ...
 * by reading the topic's transcript JSONL from disk (the legacy harness mechanism #20,
 ...
 *  record, or a record missing a `message` body. Mirrors the the legacy harness
