 ...
 *
 * § Terminal-detection port, master-table row #7 (docs/research/legacy-terminal-
 * detection-keystroke-port-2026-06-25.md). Ports the legacy harness's `index.ts:1865`
 ...
 * that BLOCKS the REPL. The hard-won lesson (the legacy harness) is ESCAPE-THEN-RECOVER, never
