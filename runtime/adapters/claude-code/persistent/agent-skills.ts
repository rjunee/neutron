 ...
 *
 * P1-5 (architecture-lift audit 2026-06-27 § P1-5). the legacy harness exposes ~25 real
 ...
 * lifted from the legacy harness `~/.claude/skills/`.
 *
 ...
 * `.claude/skills/` directory is the SAME native Claude Code skill loader the legacy harness's
 ...
 * same loader + `SKILL.md` frontmatter the legacy harness's `~/.claude/skills` rides on.
 */
